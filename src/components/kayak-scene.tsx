...
export function KayakScene() {
  return (
    <div
      className="kayak-pond relative mt-12 h-28 w-full self-stretch overflow-hidden rounded-[1.75rem] ring-1 ring-border/80"
      aria-hidden="true"
    >
      ...
      <div className="kayak-cruise absolute top-6">
